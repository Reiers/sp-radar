...
//	Curio       : v1.28.0 is the mandatory mainnet release for nv28; v1.28.1
//	              is an optional follow-up. v1.28.0 ships nv28 actor support
//	              via go-state-types v0.18.0 + filecoin-ffi v1.36.0 (both
//	              identical in v1.28.1). Curio does not embed a Lotus state
//	              machine and reads StateNetworkVersion live from the
//	              connected Lotus daemon, so the lotus v1.36.0-rc1 ->
//	              v1.36.0 go.mod bump in v1.28.1 is not consensus-critical.
